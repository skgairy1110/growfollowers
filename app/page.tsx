    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-neutral-800">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link href="/dashboard" className="bg-primary text-white font-semibold text-sm px-5 py-2.5 rounded-full hover:bg-primary/90 transition flex items-center gap-2">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-card border-b border-neutral-800 px-6 py-6 flex flex-col gap-4">
            ...
            <Link href="/dashboard" className="bg-primary text-white font-semibold text-center py-3 rounded-full">Start Growing</Link>
          </div>
        )}
      </header>
      ...
      <section className="pt-36 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center relative">
        <div className="absolute inset-0 -z-10 flex items-center justify-center opacity-20 pointer-events-none">
          <div className="w-[600px] h-[600px] bg-gradient-to-tr from-primary/30 to-transparent rounded-full blur-[120px]" />
        </div>

        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-900 border border-neutral-800 text-xs text-primary font-medium mb-8">
        ...
        <h1 className="text-5xl sm:text-7xl font-bold tracking-tight max-w-4xl uppercase leading-[1.05] mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-neutral-300 to-primary">
            Let AI Do The Work.
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center mb-16">
          <Link href="/dashboard" className="w-full sm:w-auto bg-primary text-white font-semibold px-8 py-4 rounded-full hover:bg-primary/90 transition flex items-center justify-center gap-2 text-base">
        ...
        <div className="w-full max-w-4xl bg-card border border-neutral-800 rounded-2xl p-8 relative overflow-hidden shadow-2xl">
              ...
              {stages.map((s, idx) => (
                <button
                  ...
                  className={`text-xs px-3 py-1 rounded-full transition font-mono ${
                    stage === idx ? 'bg-primary text-white font-bold' : 'text-neutral-500 hover:text-white bg-neutral-900'
                  }`}
                >
                  {s}
                </button>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto border-t border-neutral-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-card border border-neutral-800 p-8 rounded-2xl">
