  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-6 sm:p-10 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <span className="text-xs font-mono text-primary">ANALYTICS & INSIGHTS</span>
      </div>
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-card border border-neutral-800 rounded-2xl p-6">
              ...
              <div className="text-xs text-primary">+{metrics?.followersChange}% growth</div>
            </div>
            <div className="bg-card border border-neutral-800 rounded-2xl p-6">
              ...
              <div className="text-xs text-primary">+{metrics?.reachChange}% growth</div>
            </div>
            <div className="bg-card border border-neutral-800 rounded-2xl p-6">
              ...
              <div className="text-xs text-primary">+{metrics?.engagementChange}% growth</div>
            </div>
            <div className="bg-card border border-neutral-800 rounded-2xl p-6">
              ...
              <div className="text-xs text-primary">+{metrics?.profileVisitsChange}% growth</div>
            </div>
          </div>
          ...
          <div className="bg-card border border-neutral-800 rounded-2xl p-8 space-y-6">
            ...
            <div className="space-y-4 text-sm">
              <div className="bg-neutral-900 border border-neutral-800 p-5 rounded-xl">
                <span className="text-xs font-mono text-primary block mb-1">WHAT HAPPENED?</span>
                <p className="text-neutral-300">{insights?.whatHappened}</p>
              </div>
              <div className="bg-neutral-900 border border-neutral-800 p-5 rounded-xl">
                <span className="text-xs font-mono text-primary block mb-1">WHY?</span>
                <p className="text-neutral-300">{insights?.why}</p>
              </div>
              <div className="bg-neutral-900 border border-neutral-800 p-5 rounded-xl">
                <span className="text-xs font-mono text-primary block mb-1">WHAT SHOULD I DO NEXT?</span>
