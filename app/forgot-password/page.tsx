...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center px-6">
      <div className="w-full max-w-md bg-[#121212] border border-neutral-800 rounded-2xl p-8 text-center">
        ...
        {submitted ? (
          <div className="p-4 bg-neutral-900 border border-neutral-800 rounded-xl text-sm text-[#B7FF00]">
          ...
          <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-4 text-left">
            <div>
              ...
              <input type="email" className="w-full bg-neutral-900 border border-neutral-800 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#B7FF00]" required />
            </div>
            <button type="submit" className="w-full bg-[#B7FF00] text-black font-semibold py-3.5 rounded-xl hover:bg-[#a3e600] transition flex items-center justify-center gap-2">
