...
export default function HowItWorksPage() {
  return (
    <div className="min-h-screen bg-background text-foreground px-6 py-24 max-w-5xl mx-auto">
      ...
      <div className="space-y-12 border-l border-neutral-800 pl-6 sm:pl-10 ml-2">
        ...
        <div>
          <span className="text-xs font-mono text-primary">STEP 02</span>
        ...
        <div>
          <span className="text-xs font-mono text-primary">STEP 03</span>
      ...
      <div className="mt-20 p-8 bg-card border border-neutral-800 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-6">
        <div>
        ...
        <Link href="/dashboard" className="bg-primary text-white font-semibold px-6 py-3 rounded-full hover:bg-primary/90 transition flex items-center gap-2">
